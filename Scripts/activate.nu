...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Professional Course\Working\Flask CRUD\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Professional Course\Working\Flask CRUD\env\Scripts\deactivate.nu'
